...
pub fn read(
    ...
    let mut bond_count: usize = 0;
    for i in 0..atoms.len() {
        nodes.push(to_node(i, &atoms, &trace, &mut bond_count)?)
    }
        ...
        assert_eq!(
            ...
            Ok(DefaultMolecule::new(vec![
                ...
                Node {
                    ...
                    bonds: vec![
                        Bond::new(2, None, 0,0),
                        Bond::new(4, Some(Parity::Negative), 2,0)
                    ]
                },
                Node {
                    atom: Atom {
                    ...
                    bonds: vec![
                        Bond::new(4, Some(Parity::Negative), 1,0),
                        Bond::new(2, None, 3,0)
                    ]
                },
                Node {
