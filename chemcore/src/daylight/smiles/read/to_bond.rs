...
mod tests {
    ...
    fn elided() {
        ...
        let bond = to_bond(0, &input, &atoms, &trace,0);

        assert_eq!(bond, Ok(Bond::new(2, None, 1, 0)))
    }
    ...
    fn double() {
        ...
        assert_eq!(bond, Ok(Bond::new(4, None, 1, 0)))
    }
    ...
    fn up_double_up() {
        ...
        let bond = to_bond(1, &input, &atoms, &trace, 0);

        assert_eq!(bond, Ok(Bond::new(4, Some(Parity::Negative), 2, 0)))
    }
    ...
    fn up_double_down() {
        ...
        assert_eq!(bond, Ok(Bond::new(4, Some(Parity::Positive), 2, 0)))
    }
    ...
    fn up_up_double_down() {
        ...
        assert_eq!(bond, Ok(Bond::new(4, Some(Parity::Negative), 3, 0)))
    }
    ...
    fn up_up_double_up() {
        ...
        assert_eq!(bond, Ok(Bond::new(4, Some(Parity::Positive), 3, 0)))
    }
    ...
    fn triple() {
        ...
        assert_eq!(bond, Ok(Bond::new(6, None, 1, 0)))
    }
    ...
    fn quadruple() {
        ...
        assert_eq!(bond, Ok(Bond::new(8, None, 1, 0)))
    }
}
