...
pub fn to_node(
    ...
    for bond in &atom.bonds {
        bonds.push(to_bond(id, bond, atoms, trace, *bond_idx)?);
...
mod tests {
    ...
    fn bracket_star_charge() {
        ...
        let result = to_node(1, &atoms, &trace, 0);
    ...
    fn carbon_dioxide_parity() {
        ...
        let atoms = from_tree(root).unwrap();
        let result = to_node(0, &atoms, &trace, 0);
    ...
    fn bracket_carbon_12() {
        ...
        let result = to_node(0, &atoms.unwrap(), &trace, 0);
    ...
    fn bracket_star_parity() {
        ...
        let atoms = from_tree(root);
        let result = to_node(1, &atoms.unwrap(), &trace, 0);
